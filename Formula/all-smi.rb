class AllSmi < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/lablup/all-smi/releases/download/v0.24.2/all-smi-macos-aarch64.zip"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/lablup/all-smi/releases/download/v0.24.2/all-smi-linux-aarch64.tar.gz"
      sha256 "bbdc3e0ea1a4e368fe5593bcdd584bf605e20c161abfba223ecce9a328581ec9"
    end
    if Hardware::CPU.intel?
      url "https://github.com/lablup/all-smi/releases/download/v0.24.2/all-smi-linux-x86_64.tar.gz"
