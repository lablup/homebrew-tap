class AllSmi < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url     "https://github.com/inureyes/all-smi/releases/download/v0.13.1/all-smi-macos-aarch64.zip"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url      "https://github.com/inureyes/all-smi/releases/download/v0.13.1/all-smi-linux-aarch64.tar.gz"
      sha256 "69ae201723e15136219e6f4464992ccd5754d19a0bc5f31bdf7d6e80b8591379"
    end
    if Hardware::CPU.intel?
      url      "https://github.com/inureyes/all-smi/releases/download/v0.13.1/all-smi-linux-x86_64.tar.gz"
