class Mlxcel < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url     "https://github.com/lablup/mlxcel/releases/download/v0.0.30/mlxcel-macos-aarch64.zip"
      sha256 "785abea3bb1527afdc72910c313f450c2678d2cd525a9c0a520c0642fa2f5589"
    end
  end
