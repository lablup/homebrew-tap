class Mlxcel < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url     "https://github.com/lablup/mlxcel/releases/download/v0.4.0/mlxcel-macos-aarch64.zip"
      sha256 "cf923888aea39085a20f7280f6da8b6dbf2ec0af18b78e778b2c8bc38dbf6075"
    end
  end
