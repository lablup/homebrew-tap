class Mlxcel < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url     "https://github.com/lablup/mlxcel/releases/download/v0.3.3/mlxcel-macos-aarch64.zip"
      sha256 "dc84d1c778cc5fc972ba890ab6989fffcd22d0b6068dd064c488c812d17f1080"
    end
  end
