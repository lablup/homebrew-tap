class Mlxcel < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url     "https://github.com/lablup/mlxcel/releases/download/v0.3.0/mlxcel-macos-aarch64.zip"
      sha256 "d55a187b83cfa538ae9adbd562068e69459f41c17fd6ee4620d42784ab05a5a2"
    end
  end
