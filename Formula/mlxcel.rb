class Mlxcel < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url     "https://github.com/lablup/mlxcel/releases/download/v0.3.1/mlxcel-macos-aarch64.zip"
      sha256 "9ac53cf7cc17782aa5dabe2270a8b0fe0eac6274f16d183dc3693c5c587468ca"
    end
  end
