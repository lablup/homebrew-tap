class Mlxcel < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url     "https://github.com/lablup/mlxcel/releases/download/v0.1.4/mlxcel-macos-aarch64.zip"
      sha256 "259daccc3ee831a927e69d97bfbe645dd492ad99357564dcbc470c691c951706"
    end
  end
