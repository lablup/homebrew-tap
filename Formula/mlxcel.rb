class Mlxcel < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url     "https://github.com/lablup/mlxcel/releases/download/v0.1.2/mlxcel-macos-aarch64.zip"
      sha256 "077683e43594d52bf73a3ac9bd5815421ff5de02eb26fcae16c520e07e72b9c1"
    end
  end
