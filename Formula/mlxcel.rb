class Mlxcel < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url     "https://github.com/lablup/mlxcel/releases/download/v0.3.2/mlxcel-macos-aarch64.zip"
      sha256 "1703804bcf16ae2d82c7ee522baeb02815a09ef062666edb41b2aa9a9ab58dcf"
    end
  end
